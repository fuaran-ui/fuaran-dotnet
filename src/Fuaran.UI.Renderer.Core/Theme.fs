...
let kindClass (kind: NodeKind<'Msg>) : string =
    ...
    | NodeKind.Layout(LayoutKind.SplitPanel _) -> "fuaran-kind-split-panel"
    | NodeKind.Layout(LayoutKind.Tabs _) -> "fuaran-kind-tabs"
    | NodeKind.Layout(LayoutKind.Stepper _) -> "fuaran-kind-stepper"
    | NodeKind.Layout(LayoutKind.SummaryList _) -> "fuaran-kind-summary-list"
    | NodeKind.Layout(LayoutKind.Disclosure _) -> "fuaran-kind-disclosure"
    | NodeKind.Layout(LayoutKind.Modal _) -> "fuaran-kind-modal"
    | NodeKind.Layout(LayoutKind.ScrollArea _) -> "fuaran-kind-scroll-area"
    | NodeKind.Display(DisplayKind.Heading _) -> "fuaran-kind-heading"
    | NodeKind.Display(DisplayKind.LabelValueRow _) -> "fuaran-kind-label-value-row"
    | NodeKind.Display(DisplayKind.Fact _) -> "fuaran-kind-fact"
    | NodeKind.Display(DisplayKind.Link _) -> "fuaran-kind-link"
    | NodeKind.Display(DisplayKind.Markdown _) -> "fuaran-kind-markdown"
    | NodeKind.Display(DisplayKind.Metric _) -> "fuaran-kind-metric"
    | NodeKind.Display(DisplayKind.Badge _) -> "fuaran-kind-badge"
    | NodeKind.Display(DisplayKind.Sparkline _) -> "fuaran-kind-sparkline"
    | NodeKind.Display(DisplayKind.Callout _) -> "fuaran-kind-callout"
    | NodeKind.Display(DisplayKind.Progress _) -> "fuaran-kind-progress"
    | NodeKind.Display(DisplayKind.Skeleton _) -> "fuaran-kind-skeleton"
    | NodeKind.Display(DisplayKind.Image _) -> "fuaran-kind-image"
    | NodeKind.Display(DisplayKind.List _) -> "fuaran-kind-list"
    | NodeKind.Display(DisplayKind.Toast _) -> "fuaran-kind-toast"
    | NodeKind.Display(DisplayKind.CodeBlock _) -> "fuaran-kind-code-block"
    | NodeKind.Display(DisplayKind.Math _) -> "fuaran-kind-math"
    | NodeKind.Display(DisplayKind.Drawing _) -> "fuaran-kind-drawing"
    ...
    | NodeKind.Switch _ ->
        ...
        "fuaran-kind-switch"
    | NodeKind.Input(InputKind.Form _) -> "fuaran-kind-form"
    | NodeKind.Input(InputKind.Filters _) -> "fuaran-kind-filters"
    | NodeKind.Input(InputKind.Button _) -> "fuaran-kind-button"
    | NodeKind.Input(InputKind.FileUpload _) -> "fuaran-kind-file-upload"
    | NodeKind.Input(InputKind.Select _) -> "fuaran-kind-select"
    | NodeKind.Visualisation(VisKind.DataGrid _) -> "fuaran-kind-grid"
    | NodeKind.Visualisation(VisKind.Chart _) -> "fuaran-kind-chart"
    | NodeKind.Visualisation(VisKind.Map _) -> "fuaran-kind-map"
