    ...
    testList
        ...
        [ test "'label' changes a Button's label — the ordinary edit" {
          ...
          test "FileUpload.multiple is writable" {
              ...
              | NodeKind.Input(InputKind.FileUpload spec) -> Expect.isTrue spec.Multiple "Multiple written"
