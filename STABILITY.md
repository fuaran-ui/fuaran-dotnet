...
## Recorded change — 0.47.0, FUARAN113 grid field grounding (fuaran#1149)
...
walk into the dataframe package this file already consumes; widening FUARAN113 past the empty-pipeline
...
arm. It rides the in-flight **0.47.0** on the same reasoning as the entries above.

**The corpus moves with it (§11 forward-coupling).** `validator/defect-vocabulary.json` gains the
FUARAN113 entry — generated by reflection over the defect DU, so it needs no hand edit, only a
